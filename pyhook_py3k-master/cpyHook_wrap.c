...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cpyHook

#else
#  define SWIG_init    init_cpyHook

#endif
#define SWIG_name    "_cpyHook"
...
SWIGINTERN PyObject *_wrap_cGetKeyState(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cGetKeyState",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_unsigned_SS_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "cGetKeyState" "', argument " "1"" of type '" "unsigned int""'");
  } 
  arg1 = (unsigned int)(val1);
  result = (unsigned int)cGetKeyState(arg1);
...
SWIGINTERN PyObject *_wrap_cSetHook(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cSetHook",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "cSetHook" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  {
...
SWIGINTERN PyObject *_wrap_cUnhook(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cUnhook",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "cUnhook" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (int)cUnhook(arg1);
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"cGetKeyState", _wrap_cGetKeyState, METH_VARARGS, NULL},
	 { (char *)"cSetHook", _wrap_cSetHook, METH_VARARGS, NULL},
	 { (char *)"cUnhook", _wrap_cUnhook, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
